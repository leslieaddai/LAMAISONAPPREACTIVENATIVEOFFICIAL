...
const BottomSheetViewOrderStatus = ({
  Data,
  ...
  const changebottomsheetvisibility = (Bool,statusname,statusid) => {
    ...
    SelectOrderStatus(Bool,statusname,statusid)
  };
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.styleBox]}>
              {Data?.map((item, index) => (
                <TouchableOpacity
                  onPress={() => {
                      changebottomsheetvisibility(false,item?.status,item?.id)
                  }}
                  key={index}
                  style={styles.itemWrap}>
                  <Text style={styles.itemTxt}>{item?.status}</Text>
...
export default BottomSheetViewOrderStatus;