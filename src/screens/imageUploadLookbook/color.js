    ...
    return(
      <TouchableOpacity onPress={()=>{
        ...
        props.navigation.goBack();
         ...
         {props.route.params.state.quantity[props.route.params.key].color===col.color_code && (<ICONS.AntDesign name="checkcircle" size={20} color="#0F2ABA" style={{position:'absolute',right:wp2(2),top:hp2(0.5),zIndex:999}} />)}
      </TouchableOpacity>
    )
  }
